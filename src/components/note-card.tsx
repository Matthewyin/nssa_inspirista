...
export function NoteCard({ note }: { note: Note }) {
  ...
  return (
    <Link href={`/notes/${note.id}`} className="block">
      <Card className="flex flex-col h-full transform transition-all duration-300 hover:scale-[1.02] hover:shadow-xl focus-within:ring-2 focus-within:ring-ring cursor-pointer">
        <CardHeader>
